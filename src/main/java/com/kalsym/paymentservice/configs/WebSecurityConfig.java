package com.kalsym.paymentservice.configs;

import com.kalsym.paymentservice.filters.SessionRequestFilter;
import com.kalsym.paymentservice.service.MySQLUserDetailsService;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests().antMatchers(
                        ...
                        "/payments/request/makePayment",
                        "/payments/postTransaction",
                        "/payments/PostTransaction",
                        "/payments/queryOrderStatus/**",
                        "/payments/request/callback",
                        "/payments/get/BNPLList",
                        "/error",
                        "/v2/api-docs",
                        "/configuration/ui",
                        "/swagger-resources/**",
